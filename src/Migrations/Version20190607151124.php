...
final class Version20190607151124 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE make (`id` INT AUTO_INCREMENT NOT NULL, `code` VARCHAR(190) NOT NULL, `description` VARCHAR(255) NOT NULL, `type` VARCHAR(190) NOT NULL, INDEX idx_make_code (code), INDEX idx_make_type (type), PRIMARY KEY(`id`)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE model (`id` INT AUTO_INCREMENT NOT NULL, `code` VARCHAR(190) NOT NULL, `description` VARCHAR(255) NOT NULL, `type` VARCHAR(190) NOT NULL, `group` VARCHAR(190) NOT NULL, INDEX idx_model_code (code), INDEX idx_model_type (type), INDEX idx_model_group (`group`), PRIMARY KEY(`id`)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
